            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2 max-h-32 overflow-y-auto border rounded p-3">
                  {["Emma Thompson", "Michael Chen", "Sarah Williams", "James Rodriguez", "Ashley Davis", "David Kim"].map((student) => (
                ...
                <Button 
                  ...
                  size="sm" 
                  className="mt-2"
                  onClick={() => setSelectedStudents(["Emma Thompson", "Michael Chen", "Sarah Williams", "James Rodriguez", "Ashley Davis", "David Kim"])}
                >
                  Select All
                </Button>
              </div>
